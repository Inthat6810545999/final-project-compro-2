...
![Score per Run](score_per_run.jpg)
...
![Enemies Defeated Histogram](enemies_defeated_hist.png)
...
![Avg Score by Class](avg_score_by_class.png)
...
![Run Duration Histogram](run_duration_hist.png)
...
![Stage Reached Bar Chart](stage_reached_bar.png)
...
![Kills vs Damage Scatter](kills_vs_damage_scatter.png)
